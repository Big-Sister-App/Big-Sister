...
* Copyright (c) 2015 Matthieu Aussaguel; Licensed MIT */(function() {
  let a; let b; let c; let d; let e; const f=function(a, b) {
    ...
    function e(a) {
      ...
      let b; let c; let d; let e; let f; return c=a.getAttribute('data-wow-offset')||this.config.offset, f=window.pageYOffset, e=f+Math.min(this.element.clientHeight, this.util().innerHeight())-c, d=this.offsetTop(a), b=d+a.clientHeight, e>=d&&b>=f;
